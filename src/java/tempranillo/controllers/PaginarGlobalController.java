 ...
 */
@Controller
public class PaginarGlobalController {

    GestionNotificacion gestnotificacion;
    @RequestMapping("paginarGlobal.htm")
    public @ResponseBody String PaginarGlobalController(HttpServletRequest hsr, HttpServletResponse hsr1) {        
       ...
       List lista= gestnotificacion.obtenerActualizaciones(urlxslt,5,numPage); 
